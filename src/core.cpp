...
kf::SampledScopeTime::SampledScopeTime(double& time_ms) :
        time_ms_(time_ms)
{
...
kf::ScopeTime::ScopeTime(const char *name_) :
        name(name_)
{
    start = (double) cv::getTickCount();
}
