...
class KF_EXPORTS TsdfVolume
{
 public:
  ...
  virtual void integrate(const Dists& dists, const Affine3f& camera_pose,
                         const Intr& intr);
  virtual void raycast(const Affine3f& camera_pose, const Intr& intr,
  ...
  void fetchNormals(const DeviceArray<Point>& cloud,
